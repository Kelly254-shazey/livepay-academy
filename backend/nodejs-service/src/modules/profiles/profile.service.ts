...
import type { CreatorProfileUpdateInput, ProfileUpdateInput } from "./profile.schemas";
...
export class ProfileService {
  ...
  async getUserProfile(userId: string) {
    ...
    const profileBio =
      (typeof settings.profileBio === "string" ? settings.profileBio : null) ??
   ...
   */
  async updateCreatorProfile(userId: string, data: CreatorProfileUpdateInput) {
    ...
    if (data.coverPhotoUrl !== undefined)
      updateData.coverPhotoUrl = data.coverPhotoUrl || null;
    if (data.focusCategories !== undefined) updateData.focusCategories = data.focusCategories;
   ...
   */
  async getCreatorProfile(searchBy: "handle" | "userId", value: string) {
    const select = {
      id: true,
      userId: true,
      handle: true,
