...
exports.encodeUrlAttribute = encodeUrlAttribute;
exports.sanitizeChatMessage = sanitizeChatMessage;
exports.sanitizeUsername = sanitizeUsername;
exports.sanitizeEmail = sanitizeEmail;
exports.getContentSecurityPolicyHeader = getContentSecurityPolicyHeader;
 ...
 */
function sanitizeHtml(input, context) {
 ...
 */
function encodeUrlAttribute(url) {
 ...
 */
function validateRedirectUrl(url, allowedOrigins = []) {
    if (!url || typeof url !== 'string') {
        return false;
    }
